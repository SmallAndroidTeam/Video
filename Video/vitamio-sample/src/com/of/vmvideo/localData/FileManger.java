package com.of.vmvideo.localData;
...
import com.of.vmvideo.utils.VideoDownload;
...
public class FileManger {
     ...
     */
     public  List<Video> getVideos(){
         ...
         if(c==null){
             c=contentResolver.query(MediaStore.Video.Media.INTERNAL_CONTENT_URI,null,null,null,MediaStore.Video.Media.DATE_TAKEN);
         }
         if(c.moveToFirst()){
                 do{
